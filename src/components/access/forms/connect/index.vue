...
<div>
    <p class="content is-size-4">
        To request access to it <button @click="login" class="button is-primary"><span class="">log on</span></button> to your Productlist account. If you don't have an account yet, <button @click="register" class="button is-primary">register</button> for one.
    </p>
</div>
</template>
